...
# Load the preprocessed bias training data and aspects data
bias_train = pd.read_csv('../News-Bias-Detection/Preprocessed Data/preprocessed_bias_train.csv')  # Ensure the data is in tokenized form
aspects_data = pd.read_csv('../News-Bias-Detection/Preprocessed Data/preprocessed_aspects.csv')  # Aspects data with 'text' and 'Aspect'
